...
public class CrazyLambdas {
    ...
    public static BiFunction<String, Integer, String> stringMultiplier() {
        return (str, n) -> String.valueOf(str).repeat(n);
    }
    ...
    public static Predicate<String> lengthInRangePredicate(int min, int max) {
        Predicate<String> limitMax = string -> string.length() <= max;
        Predicate<String> limitMin = string -> string.length() >= min;

        return limitMax.and(limitMin);
    }
    ...
    public static IntUnaryOperator boundedRandomIntSupplier() {
        return inputInt -> new Random().nextInt(inputInt);
    }
